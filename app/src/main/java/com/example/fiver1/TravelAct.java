...
public class TravelAct extends AppCompatActivity {
...
//    String user_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions= new int[]{R.drawable.t0,
                R.drawable.t1,
        ...
        answers= new int[][] {
                {R.drawable.s0 ,R.drawable.w6, R.drawable.a18},
                {R.drawable.o3 ,R.drawable.m8, R.drawable.s1},
                {R.drawable.s2 ,R.drawable.d0, R.drawable.a17},
                {R.drawable.w5 ,R.drawable.s3, R.drawable.o6},
                {R.drawable.s4,R.drawable.a19, R.drawable.o9},
                {R.drawable.g1 ,R.drawable.p2, R.drawable.s5},
                {R.drawable.g3 ,R.drawable.s6, R.drawable.o6},
                {R.drawable.w7 ,R.drawable.g11, R.drawable.s7},
                {R.drawable.s8 ,R.drawable.d8, R.drawable.a4},
                {R.drawable.o1 ,R.drawable.s9, R.drawable.m1}
        };
        // 0 1 2
        correct_answer[0] =0;
        correct_answer[1] =2;
