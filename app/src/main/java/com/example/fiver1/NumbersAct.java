...
//    String user_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions= new int[]{R.drawable.n0,
                R.drawable.n1,
        ...
        answers= new int[][] {
                {R.drawable.m0 ,R.drawable.d5, R.drawable.g4},
                {R.drawable.d1 ,R.drawable.s2, R.drawable.m1},
                {R.drawable.g8 ,R.drawable.m2, R.drawable.s4},
                {R.drawable.m3 ,R.drawable.d4, R.drawable.d19},
                {R.drawable.m4 ,R.drawable.d0, R.drawable.g7},
                {R.drawable.m5 ,R.drawable.s8, R.drawable.o2},
                {R.drawable.s3 ,R.drawable.g6, R.drawable.m6},
                {R.drawable.w10 ,R.drawable.m7, R.drawable.d3},
                {R.drawable.d9 ,R.drawable.p0, R.drawable.m8},
                {R.drawable.g0 ,R.drawable.m9, R.drawable.d13}
        };
        // 0 1 2
        correct_answer[0] =0;
        correct_answer[1] =2;
