...
//    String user_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_colours_question_act);
        ...
        answers= new int[][] {
                {R.drawable.g0 ,R.drawable.d5, R.drawable.p0},
                {R.drawable.d4 ,R.drawable.s2, R.drawable.g1},
                {R.drawable.m8 ,R.drawable.s4, R.drawable.g2},
                {R.drawable.g3 ,R.drawable.d4, R.drawable.p0},
                {R.drawable.g5 ,R.drawable.d0, R.drawable.a5},
                {R.drawable.g6 ,R.drawable.s8, R.drawable.o2},
                {R.drawable.s3 ,R.drawable.a6, R.drawable.g7},
                {R.drawable.w10 ,R.drawable.g20, R.drawable.m3},
                {R.drawable.a9 ,R.drawable.p0, R.drawable.g21},
                {R.drawable.a0 ,R.drawable.g22, R.drawable.d13}
        };
        // 0 1 2
        correct_answer[0] =0;
        correct_answer[1] =2;
