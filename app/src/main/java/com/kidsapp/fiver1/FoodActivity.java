...
// except for the ones that make the content appear under the system bars.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions= new int[]{R.drawable.c0,
                R.drawable.c1,
                R.drawable.c2, R.drawable.c3, R.drawable.c4,
                R.drawable.c5,
                R.drawable.c6,
                R.drawable.c7,
                R.drawable.c8,
        ...
        answers= new int[][] {
                {R.drawable.d0 ,R.drawable.w6, R.drawable.g1},
                {R.drawable.p0 ,R.drawable.m8, R.drawable.d1},
                {R.drawable.d2 ,R.drawable.g10, R.drawable.a17},
                {R.drawable.w5 ,R.drawable.d3, R.drawable.o9},
                {R.drawable.d4,R.drawable.a19, R.drawable.m9},
                {R.drawable.g1 ,R.drawable.p2, R.drawable.d5},
                {R.drawable.g3 ,R.drawable.d6, R.drawable.o6},
                {R.drawable.w7 ,R.drawable.g11, R.drawable.d7},
                {R.drawable.d8 ,R.drawable.p1, R.drawable.a4},
                {R.drawable.o1 ,R.drawable.d9, R.drawable.m1}
        };
        // 0 1 2
        correct_answer[0] =0;
        correct_answer[1] =2;
