...
import com.kidsapp.fiver1.gameactivities.Contact;

public class GameMainAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdsClass aa= new AdsClass(GameMainAct.this);
...
//        aa.rewardedads();
        ...
        {
            Intent i = new Intent(GameMainAct.this,No_internet.class);
            startActivity(i);
        }
        else
        {
//            Toast.makeText(this, "Connected", Toast.LENGTH_SHORT).show();
        ...
        mp1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GameMainAct.this,GameLoader.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(GameMainAct.this, "Home", Toast.LENGTH_SHORT).show();
            }
        });
        category.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent s =new Intent(GameMainAct.this,Category.class);
                startActivity(s);
            }
        });
        contact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent g =new Intent(GameMainAct.this, Contact.class);
                startActivity(g);
            }
        });
...
//            Intent i = new Intent(GameMainAct.this, Screen_one.class);
//            startActivity(i);
        } else {
    ...
    private void showBottomSheetDialog() {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shareBody = "Learning and Games for kids";
                sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Learning App");
        ...
        contact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String mailto = "mailto:pakdeveloper06@gmail.com" +
                        "?cc=" +
                ...
                try {
                    ...
                    Toast.makeText(GameMainAct.this, "Error to open email app", Toast.LENGTH_SHORT).show();
                }
