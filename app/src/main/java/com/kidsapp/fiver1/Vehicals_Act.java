...
public class Vehicals_Act extends AppCompatActivity {
...
// except for the ones that make the content appear under the system bars.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicals_);
        ...
        questions= new int[]{R.drawable.q0,
                R.drawable.q1,
                R.drawable.q2, R.drawable.q3, R.drawable.q4,
                R.drawable.q5,
                R.drawable.q6,
                R.drawable.q7,
                R.drawable.q8,
        ...
        answers= new int[][] {
                {R.drawable.o0 ,R.drawable.c16, R.drawable.d18},
                {R.drawable.d4 ,R.drawable.d15, R.drawable.o1},
                {R.drawable.a4 ,R.drawable.d6, R.drawable.o2},
                {R.drawable.o3 ,R.drawable.d4, R.drawable.p0},
                {R.drawable.o4 ,R.drawable.d0, R.drawable.a5},
                {R.drawable.o5 ,R.drawable.a24, R.drawable.d2},
                {R.drawable.w9 ,R.drawable.a6, R.drawable.o6},
                {R.drawable.w10 ,R.drawable.o7, R.drawable.m3},
                {R.drawable.a9 ,R.drawable.p0, R.drawable.o8},
                {R.drawable.a0 ,R.drawable.o9, R.drawable.d13}
        };
        // 0 1 2
        correct_answer[0] =0;
        correct_answer[1] =2;
